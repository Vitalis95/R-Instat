...
Public Class dlgOutfillingStationData
    ...
    Public clsSelectFunction, clsSelectFunction2 As New RFunction
    ...
    Private Sub SetDefaults()
        ...
        clsDummyFunction.AddParameter("calc", "False", iPosition:=3)
        clsDummyFunction.AddParameter("checked", "auto", iPosition:=4)
    ...
    Private Sub cmdOptions_Click(sender As Object, e As EventArgs) Handles cmdOptions.Click
        sdgOptions.SetRCode(clsNewDoFillingFunction:=clsDoFillingFunction, clsNewDummyFunction:=clsDummyFunction, bReset:=bResetSubdialog)
